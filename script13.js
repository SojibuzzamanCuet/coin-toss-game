...
function displayRandom(random){
  ...
  console.log(random);
  if(random===1){
      displayResult.style.backgroundImage= "url(image/heads.png)";
  }
  else{
      displayResult.style.backgroundImage = "url(image/tails.png)";
  }
}
function tallyScore(random,userPick,computerPick){
    ...
    if(userScore===5&& computerScore===5){
        winner.innerHTML = `<h1>its a tie</h1>`;
    }
    else if(userScore===5){
        winner.innerHTML = `<h1>user win</h1>`;
    }
